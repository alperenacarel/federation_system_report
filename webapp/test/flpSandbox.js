		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Federation Player Report ",
									"targetURL": "#federationreport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"federationreport-display": {
								"semanticObject": "federationreport",
								"action": "display",
								"description": "Federation Player Report",
								"title": "Federation Player Report ",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=federationreport",
									"url": sap.ui.require.toUrl("federationreport")
								}
							}
						}
					}
